...
% t_sample        = [Offlinedata(off_idx(1):off_idx(2),1);Offlinedata(off_idx(3):off_idx(4),1);Offlinedata(off_idx(5):off_idx(6),1);Offlinedata(off_idx(7):off_idx(8),1)];
...
%% Exponential Pulse fed-batch : non-induced
