...
plot(Plot_data(1).biomass(:,1),0.35*Plot_data(1).biomass(:,2),'r*')
plot(Plot_data(2).biomass(:,1),0.35*Plot_data(2).biomass(:,2),'k*')
plot(Plot_data(3).biomass(:,1),0.35*Plot_data(3).biomass(:,2),'c*'); hold off

ylabel('X [g L^{-1}]'); %xlabel('Fermentation Time (h)')
title('Biomass')
set(gca,'LineWidth',2,'FontSize',FS,'FontWeight',FontWeight,'xtick',[]) 
...
ylabel('S [g L^{-1}]'); %xlabel('Fermentation Time [h]')
title('Glucose')
set(gca,'LineWidth',2,'FontSize',FS,'FontWeight',FontWeight,'xtick',[]) 
...
ylabel('A [g L^{-1}]','Fontsize',8); %xlabel('Fermentation Time [h]','Fontsize',8)
title('Acetate')
set(gca,'LineWidth',2,'FontSize',FS,'FontWeight',FontWeight,'xtick',[]) 
legend('Model','Data','Location','NorthWest');legend('boxoff')
...
ylabel('P [mg g^{-1}]'); xlabel('Fermentation Time [h]')
title('Product')
set(gca,'LineWidth',2,'FontSize',FS,'FontWeight',FontWeight) 
legend('Model','Data','Location','NorthWest');legend('boxoff')
