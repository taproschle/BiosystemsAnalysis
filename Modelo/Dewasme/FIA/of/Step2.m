...
thetaLow    = 0.9*thetaNom; 
thetaHigh   = 1.1*thetaNom;
...
X0Model = eval(['@x0' ModelName]);      %Initial conditions generator for model states
dxdth0  = eval(['@dICdth',ModelName]);  %Initial conditions generator for matrix dx_th/dt (I.C. for Eq.3 in Stigter & Molenaar (2015))
